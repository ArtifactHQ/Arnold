    ...
    class McpSmokeTest < ActiveSupport::TestCase
      ...
      test "tools/list returns all 21 registered tools" do
        ...
        expected_tools = %w[
          ...
          create_product init_project explore_persona explore_capability what_if get_history
        ]
